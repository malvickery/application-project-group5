...
document.querySelectorAll(".password-confirm .afterInput-confirm").forEach(element => {
    ...
    element.onclick = (e) => {
        ...
        do {
            passwordDiv = passwordDiv.parentNode
        } while (!passwordDiv.classList.contains("password-confirm"));

        let input = passwordDiv.querySelector("input");
        let svg = passwordDiv.querySelector(".afterInput-confirm path");
        if (input.getAttribute("type") === "text") {
...
document.querySelectorAll(".password-confirm .afterInput-confirm").forEach(element => {
    ...
    element.onclick = (e) => {
        ...
        let input = passwordDiv.querySelector("input-div");
        let svg = passwordDiv.querySelector(".afterInput-confirm path");
        if (input.getAttribute("type") === "text") {
