        ...
        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="input-div">
                            ...
                            <input id="password-confirm" value="password" type="password" class="password-confirm"
            ...
            <div class="register-box">
                <p class="paragraph-register">Already have an account?
                    <br>
                    <a class="nav-link-r" href="{{ route('login') }}">{{ __('Login') }}</a>
                </p>
            </div>
        </div>
    </div>
